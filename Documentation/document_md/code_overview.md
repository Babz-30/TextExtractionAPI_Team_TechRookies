...
[Methodology](#methodology)
    1. [Image Preprocessing](#image-preprocessing)
        ...
        - [Mirror](#mirror)
    2. [Optical Character Recognition (OCR)](#optical-character-recognition-ocr)
    3. [Text Embedding](#text-embedding)
    4. [Similarity Computation](#similarity-computation)
    5. [Performance Evaluation](#performance-evaluation)
    6. [Final Selection](#final-selection)
...
<div id="figure1" align="center">
  ![Block Diagram](Documentation/document_images/blockdiag.png)
  <p style="text-align: center;">Figure 1: Block diagram representing the workflow of OCR</p>
</div>
...
5. **Performance Evaluation**: 
   ...
   Additionally, we compute dictionary accuracy, which determines the proportion of recognized words that exist in a predefined dictionary. This metric helps assess OCR performance by filtering out incorrectly recognized words. Furthermore, the mean confidence score is calculated by averaging the confidence levels assigned by the OCR engine to each word. A high confidence score indicates that the OCR engine is more certain about its text recognition. [`TextAnalysis`](Source/OCRApplication/OCRApplication/Services/TextAnalysis.cs)
